...
exports.transform = (node, context, isInParentParens = false) => {
    ...
    function _c(t, n, span, { processSpan = true, hasParentParens = false } = {}) {
        const newNode = Object.assign({ type: t }, transformSpan(span, context, processSpan, hasParentParens), n);
        switch (t) {
            case 'Identifier': {
            ...
            case 'NumericLiteral': {
                ...
                numericLiteral.extra = Object.assign({}, numericLiteral.extra, { raw: context.text.slice(numericLiteral.start, numericLiteral.end), rawValue: numericLiteral.value });
                break;
            }
            case 'StringLiteral': {
                const stringLiteral = newNode;
                stringLiteral.extra = Object.assign({}, stringLiteral.extra, { raw: context.text.slice(stringLiteral.start, stringLiteral.end), rawValue: stringLiteral.value });
                break;
            }
        }
        return newNode;
...
function transformSpan(span, context, processSpan, hasParentParens) {
    if (!processSpan) {
