...
function transformTemplateBindings(rawTemplateBindings, context) {
    ...
    for (let i = 0; i < templateBindings.length; i++) {
        ...
        if (lastTemplateBinding &&
            ...
            const updateSpanEnd = (node, end) => (Object.assign({}, node, transform_1.transformSpan({ start: node.start, end }, context)));
            const updateExpressionAlias = (expression) => (Object.assign({}, updateSpanEnd(expression, alias.end), { alias }));
            ...
            if (lastNode.type === 'NGMicrosyntaxExpression') {
                ...
                body.push(updateSpanEnd(Object.assign({}, lastNode, { expression }), expression.end));
            }
            else {
    ...
    function _c(t, n, span, stripSpaces = true) {
        return Object.assign({ type: t }, transform_1.transformSpan(span, context, stripSpaces, false), n);
    }
