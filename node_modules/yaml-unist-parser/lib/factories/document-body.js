...
function createDocumentBody(position, content, endComments) {
    return tslib_1.__assign({}, node_1.createNode("documentBody", position), end_comment_attachable_1.createEndCommentAttachable(endComments), { children: !content ? [] : [content] });
}
