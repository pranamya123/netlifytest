...
function createDocumentHead(position, children, endComments, trailingComment) {
    return tslib_1.__assign({}, node_1.createNode("documentHead", position), end_comment_attachable_1.createEndCommentAttachable(endComments), trailing_comment_attachable_1.createTrailingCommentAttachable(trailingComment), { children: children });
}
