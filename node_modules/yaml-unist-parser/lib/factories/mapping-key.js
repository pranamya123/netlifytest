...
function createMappingKey(position, content) {
    return tslib_1.__assign({}, node_1.createNode("mappingKey", position), trailing_comment_attachable_1.createTrailingCommentAttachable(), end_comment_attachable_1.createEndCommentAttachable(), { children: !content ? [] : [content] });
}
